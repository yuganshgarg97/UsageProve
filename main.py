...
#if not then run the command insystem using os module and save it
...
def speed_test():
    ...
    print("Download Speed = ",speed[0])
    print("Upload speed",speed[1])
